<template>
  <div class="col-span-1 lg:col-span-6">
    ...
    <div class="p-10 rounded-md shadow-md bg-green-300">
      <div class="mb-6">
      ...
      <div>
        <button class="w-full text-ceenter px-4 py-3 bg-blue-500 rounded-md shadow-md text-white font-semibold" @click="finishPayment">
          Confirm payment
        </button>
      </div>
    </div>
