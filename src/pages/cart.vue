  ...
  <div>
    ...
    <div class="grid grid-cols-3 ">
      <div class="card remove">
        ...
        <h4 class="neon-sub text-1xl mt-2">
          Monstera Deliciosa  $55
        </h4>
        <h4>QTY:3</h4>
        <input id="Remove" class="remove center" type="checkbox" name="Remove" label="Remove">
        <label for="Remove">Remove</label>
      </div>
      <div class="card remove grid-row-1">
      ...
      <div class="card remove grid-row-2">
